...
namespace MediaBizzare.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(MediaBizzareContext context)
        {
            _context = context;
        }
        ...
        {
            var mediaBizzareContext = _context.Categories.Include(c => c.Department);
        ...
        public async Task<IActionResult> Create([Bind("Id,DepartmentId,Name,Slug")] Category category)
        {
            ...
            ViewData["DepartmentId"] = new SelectList(_context.Departments, "Id", "Description", category.DepartmentId);
            return View(category);
        }
